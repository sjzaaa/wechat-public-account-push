...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxe2afb55129e359a5',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'b2f81e7ca137dcd5d6036436309e3aa9',
   ...
   */
  USERS: [oppF76Bgx6ilsrBayDYp67kjrTKk]
    {
      // 想要发送的人的名字
      name: '宝贝',
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'oppF76Bgx6ilsrBayDYp67kjrTKk',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'PSaK2AvDPd1oC7tFbW4DJRFns5nBJHALG5Wh90ktfMY',
      // 所在省份
      province: '重庆',
      // 所在城市
      city: '万州',
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2019-01-05' },
